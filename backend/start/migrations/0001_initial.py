# Generated by Django 5.1 on 2025-02-17 07:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games', to='start.info')),
            ],
        ),
        migrations.CreateModel(
            name='Drives',
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='drives', to='start.games')),
                ('info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='drives', to='start.info')),
            ],
        ),
        migrations.CreateModel(
            name='Conferences',
            fields=[
                ...
                ('championship', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='start.games')),
                ('info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conferences', to='start.info')),
            ],
        ),
        migrations.CreateModel(
            name='Odds',
        ...
        migrations.AddField(
            model_name='playoff',
            name='seed_1',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='seed_1', to='start.teams'),
        ),
        migrations.AddField(
            model_name='playoff',
            name='seed_2',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='seed_2', to='start.teams'),
        ),
        migrations.AddField(
            model_name='playoff',
            name='seed_3',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='seed_3', to='start.teams'),
        ),
        migrations.AddField(
            model_name='playoff',
            name='seed_4',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='seed_4', to='start.teams'),
        ),
        migrations.AddField(
            model_name='players',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='players', to='start.teams'),
        ),
        migrations.AddField(
            model_name='info',
            name='team',
