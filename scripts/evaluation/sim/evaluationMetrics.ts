...
export const createEqualTeamTotals = (): EqualTeamTotals => ({
  games: 0,
  points: 0,
  plays: 0,
  scrimmagePlays: 0,
...
export const createConceptTotals = () => new Map<OffensiveConcept, ConceptTotal>(
  OFFENSIVE_CONCEPTS.map(concept => [concept, emptyConceptTotal()]),
);

export const createDefensiveTotals = () => new Map<DefensiveIntent, ConceptTotal>(
  DEFENSIVE_INTENTS.map(intent => [intent, emptyConceptTotal()]),
);

export const createDefensiveMatchupTotals = () => new Map<
  DefensiveIntent,
...
export const summarizeConcepts = (
...
export const summarizeDefensiveTotals = <Key extends string>(
  keys: readonly Key[],
...
export const summarizeDefensiveMatchups = (
...
export const summarizeEqualTeams = (totals: EqualTeamTotals): EqualTeamMetrics => ({
...
export const summarizeEqualTeamDistributions = (
  totals: EqualTeamTotals,
...
export const summarizeTries = (totals: EqualTeamTotals): TryMetrics => ({
  touchdownDrives: {
...
export const summarizeClock = (totals: EqualTeamTotals): ClockMetrics => ({
