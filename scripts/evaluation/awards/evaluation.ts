import { AWARD_DEFINITIONS, type AwardSlug } from '../../../src/domain/league/awardDefinitions';
import type { AwardScoringSnapshot } from '../../../src/domain/league/awards';
import {
  AWARD_SCORING_CONFIG,
  AWARD_TUNING_CONTROLS,
  validateAwardScoringConfig,
  type AwardScoringConfig,
} from '../../../src/domain/league/awardScoringConfig';
