...
const Home = () => {
  ...
  // Handle data initialization when data changes
  const handleDataChange = (data: LaunchProps) => {
    if (data?.selected_year && selectedYear !== data.selected_year) {
  ...
  return (
    ...
    >
      {(data) => {
        const filteredTeams = getFilteredTeams(data);
        const conferenceOptions = getConferenceOptions(data);
