...
const GameControls = ({ phase, decisionPrompt, onAdvance, onDecision }: GameControlsProps) => {
        ...
        >
          ...
          >
            ...
            {decisionPrompt.type === 'fourth_down' && (
              <>
                <Button variant="outlined" size="small" onClick={() => onDecision('punt')}>
                  Punt
                </Button>
                <Button variant="outlined" size="small" onClick={() => onDecision('field_goal')}>
                  Field Goal
                </Button>
              </>
            )}
