...
import type { NextSeasonConfiguration, NextSeasonPreview } from '../../types/domain';
...
export const PostseasonPreviewPanel = ({ configuration, preview }: PostseasonPreviewPanelProps) => {
  ...
  const rows = [
    ...
    },
    {
      ...
      current: yesNo(configuration.conferenceChampionsReceiveTopSeeds ?? false),
      historical: yesNo(historical.conferenceChampionsReceiveTopSeeds),
    },
  ];
