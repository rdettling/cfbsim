...
const RankingMovement = ({ movement }: { movement: number }) => {
  if (movement === 0) {
    return (
      <Typography variant="body2" color="text.secondary" aria-label="No rank change">
        —
      </Typography>
    );
  }
  ...
  <DataTable ariaLabel="College football rankings" minWidth={1100}>
    <TableHead>
      <TableRow sx={{ bgcolor: 'background.default' }}>
        ...
        <TableCell align="right" sx={{ width: 110 }}>Poll</TableCell>
        <TableCell align="right" sx={{ width: 110 }}>SOR</TableCell>
