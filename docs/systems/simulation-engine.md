...
- Drive/play IDs are globally allocated from league counters and must be monotonic.
...
- Live mode exposes drive-by-drive and play-by-play causality rather than a single final score.
- Quarter/clock behavior visibly changes near end-of-half/end-of-game situations.
- Late-game tempo and decision behavior becomes noticeably pass-heavier when trailing and slower when protecting leads.
- Completed interactive games return final headline/score metadata consistent with batch-simulated games.
